...
import { useDisplayMode, isIOSDevice, isAndroidDevice } from '../hooks/useDisplayMode.js'
...
export default function HomeGate({ restaurantId, tableNumber, onScanned, onIntroStart, onIntroEnd, isChatOpen }) {
  ...
  return <MainScreen onIntroStart={onIntroStart} onIntroEnd={onIntroEnd} isChatOpen={isChatOpen} />
}
