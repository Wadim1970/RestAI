...
const AIChatModal = ({ isOpen, onClose, pageContext, sessionId, messages, setMessages, guestId, restaurantId, tableNumber, isFirstLaunch = false, onShowDish, onHideDish }) => {
      ...
      > {/* Основное окно */}
        ...
        {viewMode === 'voice' && (
          <VoiceStage
            ...
            onShowDish={onShowDish}
            onHideDish={onHideDish}
          />
        )}
